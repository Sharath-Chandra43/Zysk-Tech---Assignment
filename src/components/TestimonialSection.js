...
const TestimonialSection = () => {
  return (
    <div className='w-full h-auto p-16 gap-16'>
        ...
        <h1 className='text-black font-semibold text-2xl'>Sisyphus</h1>
        </div>
        <div>
         <h1 className='text-black font-semibold text-3xl mt-3 mb-5'>We’ve been using Untitled to kick start every new project and can’t imagine working without it.</h1>
        </div>
